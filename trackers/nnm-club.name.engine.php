	...
	public static function checkCookie($sess_cookie)
	{
        $result = Sys::getUrlContent(
        	array(
        		...
        		'returntransfer' => 1,
        		'encoding'       => 1,
        		'url'            => 'http://nnm-club.name/forum/index.php',
        		'cookie'         => $sess_cookie,
        		'sendHeader'     => array('Host' => 'nnm-club.name', 'Content-length' => strlen($sess_cookie)),
		...
		if (nnmclub::$exucution)
		{
            ...
            $page = Sys::getUrlContent(
            	array(
            		...
            		'returntransfer' => 1,
            		'encoding'       => 1,
            		'url'            => 'http://nnm-club.name/forum/viewtopic.php?t='.$torrent_id,
            		'cookie'         => nnmclub::$sess_cookie,
            		'sendHeader'     => array('Host' => 'nnm-club.name', 'Content-length' => strlen(nnmclub::$sess_cookie)),
            		'convert'        => array('windows-1251', 'utf-8//IGNORE'),
            	)
            );
								...
								if ($date != $timestamp)
								{
                                    ...
                                    $torrent = Sys::getUrlContent(
	                                	array(
	                                		...
	                                		'follow'         => 1,
	                                		'returntransfer' => 1,
	                                		'url'            => 'https://nnm-club.name/forum/download.php?id='.$download_id,
	                                		'cookie'         => nnmclub::$sess_cookie,
	                                		'sendHeader'     => array('Host' => 'nnm-club.name', 'Content-length' => strlen(nnmclub::$sess_cookie)),
	                                		'referer'        => 'http://nnm-club.name/forum/viewtopic.php?t='.$torrent_id,
	                                	)
	                                );
